...
export default Component.extend({
    ...
    _validateFields: function () {
        ...
        isLastNameEnoughLong = Ember.computed.gte('friend.lastname.length', 3),
        isDateValid = Ember.computed('friend.friendsSince', function () {
    ...
    actions: {
        save(friend) {
            ...
            friend.save()//.then(() => {
                this.get('router').transitionTo('friends');
            //}) .catch((adapterError) => {
